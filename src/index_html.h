...
.sc-values{display:flex;flex-wrap:wrap;gap:4px;margin-top:5px;padding-top:4px;border-top:1px solid #222}
.sc-val{background:#0d180d;border:1px solid #1e3a1e;border-radius:2px;padding:1px 6px;font-size:11px}
.sc-val-k{color:#555}
.sc-val-v{color:#4caf50;margin-left:3px}
#other-sensors-details{margin-top:8px}
#other-sensors-details summary{cursor:pointer;font-size:10px;color:#555;text-transform:uppercase;letter-spacing:1px;padding:3px 0;user-select:none}
#other-sensors-details summary:hover{color:#888}
#other-sensors-details[open] summary{color:#888}
  ...
  <section id="wifi-section" class="draggable-section" draggable="true" style="display:none">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-start">
      <div>
        ...
        <div class="form-row"><label>Password</label><input type="password" id="wifi-pass" placeholder="leave empty for open"><button class="btn" onclick="togglePass('wifi-pass',this)" style="margin-top:0;margin-left:4px">show</button></div>
        ...
        <div class="form-row"><label>Password</label><input type="password" id="wifi-pass2" placeholder="leave empty for open"><button class="btn" onclick="togglePass('wifi-pass2',this)" style="margin-top:0;margin-left:4px">show</button></div>
